...
// Baked, offline pools for every fixed mode. Generated by
// scripts/generate-static-pools.mjs from a non-throttled IP. Used as a fallback
// whenever the live iTunes API is unreachable (it throttles Cloudflare IPs hard).
import STATIC_POOLS from './static-pools.json';
...
function staticPoolFor(mode: GameMode): Song[] | null {
  const pool = (STATIC_POOLS as Record<string, Song[]>)[mode];
